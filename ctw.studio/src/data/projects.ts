export type GalleryItem =
  ...
  | { type: 'video'; src: string; poster?: string; caption?: string; width?: number; height?: number; featured?: boolean }
...
At the 14-hour Ajax Hackathon, our multidisciplinary team used TF15 data from Ajax vs Fortuna Sittard to explore another use. We reconstructed 22 players from 21 body points per player at 25 fps, then built 3D playback, player POV, head-to-ball angle, scan rate, and fixation analysis. Our team won an award.`,
    ...
    institution: null,
    gallery: [
      { type: 'video', src: 'projects/ajax-visual-intelligence/demo.mp4', poster: 'projects/ajax-visual-intelligence/video-poster.avif', caption: 'Thirty-second walkthrough of skeletal tracking, player POV, and comparison metrics', width: 1920, height: 1080, featured: true },
