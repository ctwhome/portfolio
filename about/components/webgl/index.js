...
function Particles({
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uColor: {
        value: new Color('rgb(91, 194, 231)'),
      },
      uScroll: {
        value: 0,
      },
...
export function Arm() {
  ...
  const { scene: arm1 } = useGLTF(`${basePath}/models/arm.glb`)
  const { scene: arm2 } = useGLTF(`${basePath}/models/arm2.glb`)
