<!-- FILEPATH: /Users/ctw/Sites/github/portfolio/nuxt/components/DaisyuiThemeSwitcher.svelte -->
<script>
  ...
  // let DAISYUI_VERSION = process.env.DAISYUI_VERSION;
  // let scrolled = false;
  let themes = [
    { id: 'ctw', name: '🌠  ctw' },
    { id: 'light', name: '🔆  light' },
...
<div tabindex="1" class={'dropdown dropdown-end flex-none' + className} title="Change Theme">
  <div tabindex="0" class="m-1 normal-case btn-ghost btn opacity-70 hover:opacity-100">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4 ml-1 fill-current" viewBox="0 0 1792 1792">
      <path d="M1395 736q0 13-10 23l-466 466q-10 10-23 10t-23-10l-466-466q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l393 393 393-393q10-10 23-10t23 10l50 50q10 10 10 23z"/>
    </svg>
  </div>
  <div class=" z-50 mt-16 overflow-y-auto shadow-2xl top-px dropdown-content h-96 w-52 rounded-b-box bg-base-200 text-base-content">
